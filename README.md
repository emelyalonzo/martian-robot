<h1> Martian Robot </h1><br>
<p> The surface of Mars can be modelled by a rectangular grid around which robots are
able to move according to instructions provided from Earth. 
This program determines each sequence of robot positions and reports the final position of the
robot.
...
previously lost is simply ignored by the current robot.</p><br>

<h2> input</h2>
<p> The first line of input is the upper-right coordinates of the rectangular world, the
...
All instruction strings will be less than 100 characters in length.</p><br>
